...
//     logTextareaLength('infectionInput');
// });
...
// 핸드아웃 카드 생성 함수
function createHandoutCard(shock, infection, secret) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function(event) {
        ...
        const newCardHTML = createHandoutCard(shockInput, infectionInput, secretInput);
